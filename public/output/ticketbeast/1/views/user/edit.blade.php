    ...
    <div class = "container">
        ...
        <form method = "post" class = "form-horizontal" action = "user/update">
            ...
            <div class = "form-group">
                ...
                <input type = "text" class = "form-control" name = "stripe_account_id" value = "{{ $user->stripe_account_id }}" id = "stripe_account_id">
            </div>
            <div class = "form-group">
                <label class = "" for = "stripe_access_token">Stripe Access Token</label>
                <input type = "text" class = "form-control" name = "stripe_access_token" value = "{{ $user->stripe_access_token }}" id = "stripe_access_token">
            </div>
            <div class = "form-group">
