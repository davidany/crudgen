							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<a class="btn btn-sm btn-info" href="/output-variable/edit/{{$outputVariable['id']}}">Edit</a>

										 </div>
										<a class="btn btn-sm btn-info" href="/output-variable/destroy/{{$outputVariable['id']}}">Delete</a>
										</td>
								</tr>
						@endforeach
					@endif
