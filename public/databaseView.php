...
$result         = $databaseObject->selectAll();
?>
	...
	<div class = "col-md-8">
		...
		<table align = "center" class = "table table-striped table-bordered">
			...
			if (isset($_GET['databaseId'])) {
				if ($_GET['databaseId']) {
					$databaseObject->delete($_GET['databaseId']);
					send_to('databaseView.php');
				}
			}
			...
			foreach ($result as $rows) {
				...
				?>
				<tr>
					<td><a href="projectView.php?databaseId=<?php echo $rows->id; ?>"><?php echo ucwords($rows->name); ?></a></td>
